...
involved, and the difference is worth stating. That guide is a community
document with an author, so the generator is careful to take specifications
and leave prose. This list is the manufacturer's own factual claim about its
own product, published by the manufacturer, and it contains no prose to leave.
